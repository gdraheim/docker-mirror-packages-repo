...
class DockerMirrorPackagesRepo:
    ...
    def image_base_image(self, image: str) -> str: ...
    def image_base_image_detect(self, cname: str, tempdir: str) -> Tuple[str, str]: ...
    ...
    def get_extra_mirrors(self, image : str) -> List[DockerMirror]: 
        mirrors: List[DockerMirror]
    def get_epel_docker_mirrors(self, ver : str) -> List[DockerMirror]: ...
    def get_epel_docker_mirror(self, ver : str) -> DockerMirror: ...
