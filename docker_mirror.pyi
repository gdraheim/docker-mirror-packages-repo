...
class DockerMirrorPackagesRepo:
    ...
    def get_debian_latest_version(self, version: str) -> str: ...
    def get_debian_docker_mirror(self, image: str) -> DockerMirror: ...
    def get_debian_docker_mirrors(self, image: str) -> List[DockerMirror]: ...
